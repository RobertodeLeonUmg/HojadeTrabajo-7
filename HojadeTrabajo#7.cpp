...
public:
    void obtenerDatosPersona() {
        ...
        cin >> datos.edad;
        cout << "Ingrese el dia de cumpleanos: ";
        cin >> datos.diaCumple;
        cout << "Ingrese el mes de cumpleanos: ";
        cin >> datos.mesCumple;
        cout << "¿Tiene trabajo? (1: Si / 0: No): ";
...
public:
    void obtenerDatosEstudiante() {
        obtenerDatosPersona();
        cout << "\nDatos Estudiante\n";
        cout << "Ingrese el numero de carnet de estudiante: 5090-23-";
        cin >> numeroCarnet;
        cout << "Ingrese el semestre: ";
        cin >> semestre;
        cout << "Ingrese el nombre de la carrera universitaria: Ingenieria en ";
        cin >> carreraUniversitaria;
        cout << "1ra. Lunes, Miercoles y Viernes de 07:00 a 12:00, Martes y Jueves de 08:30 a 12:00\n";
        cout << "2da. Lunes, Miercoles y Viernes de 07:00 a 12:00, Martes y Jueves de 07:00 a 10:00\n";
        cout << "Elija un horario de clases (1 o 2): ";
        int opcion;
        cin >> opcion;
        horarioClases = (opcion == 1) ? "Lunes, Miercoles y Viernes de 07:00 a 12:00, Martes y Jueves de 08:30 a 12:00"
                                      : "Lunes, Miercoles y Viernes de 07:00 a 12:00, Martes y Jueves de 07:00 a 10:00";
    }
